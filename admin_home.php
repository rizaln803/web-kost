...
<header>
    ...
    <div class="wrapper container">
        <div class="top-wrapper">
            ...
            <a class="ps-0 text-decoration-none h1 catalog-title border-bottom" href="kost_ketintang_admin.php?&kategori=kost_terbaru">Kamar Kost Terbaru</a>
                <?php $i=1; ?>
        ...
        <div class="top-wrapper">
            <div class="catalog-wrapper border border-muted pt-3 pb-5 rounded-3 border-2 row">
                <a class="ps-0 text-decoration-none h1 catalog-title border-bottom" href="kost_ketintang_admin.php?&kategori=kost_putra">Kamar Kost Putra Terbaru</a>
                <?php $i=1; ?>
        ...
        <div class="top-wrapper">
            <div class="catalog-wrapper border border-muted pt-3 pb-5 rounded-3 border-2 row">
                <a class="ps-0 text-decoration-none h1 catalog-title border-bottom" href="kost_ketintang_admin.php?&kategori=kost_putri">Kamar Kost Putri Terbaru</a>
                <?php $i=1; ?>
        ...
        <div class="top-wrapper">
            <div class="catalog-wrapper border border-muted pt-3 pb-5 rounded-3 border-2 row">
                <a class="ps-0 text-decoration-none h1 catalog-title border-bottom" href="kost_ketintang_admin.php?&kategori=kost_campur">Kamar Kost Campur Terbaru</a>
                <?php $i=1; ?>
